...
WooCommerce cart recovery workflow patterns, notices, and customer follow-up automations.

## Client value

Cart-level prompts, recovery triggers, and customer lifecycle integration points.
